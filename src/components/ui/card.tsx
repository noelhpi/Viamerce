...
export function Card({ children, className = "", color = "cyan" }: CardProps) {
  ...
  const colors = {
    ...
    rose:  { border: "rgba(244,63,94,0.15)",  hover: "rgba(244,63,94,0.5)",  glow: "rgba(244,63,94,0.15)",  light: "rgba(244,63,94,0.10)"  },
    indigo: { border: "rgba(99,102,241,0.15)", hover: "rgba(99,102,241,0.5)", glow: "rgba(99,102,241,0.15)", light: "rgba(99,102,241,0.10)" },
  };
