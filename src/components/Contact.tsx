...
export function Contact() {
  const whatsappUrl =
    "https://wa.me/5534984441801?text=Ol%C3%A1!%20Gostaria%20de%20saber%20mais%20sobre%20a%20consultoria%20Viamerce";
  const emailUrl = "mailto:viamerce@outlook.com?subject=Contato pelo Site Viamerce&body=Olá! Gostaria de saber mais sobre a consultoria de e-commerce.";
                ...
                <div className="pt-10 mt-2 space-y-4 border-t border-white/5">
                  ...
                  <div className="flex items-center justify-between p-5 rounded-2xl bg-[#0A1628]/40 border border-white/5 group hover:bg-[#0A1628]/60 transition-all duration-300 hover:scale-[1.02]">
                    <div className="flex items-center gap-4">
                      ...
                      <span className="text-gray-300 font-medium">viamerce@outlook.com</span>
                    </div>
                    <button 
                      onClick={() => copyToClipboard('viamerce@outlook.com', 'email')}
